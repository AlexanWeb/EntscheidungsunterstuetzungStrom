...
class CreatePricesinteradaysPredictionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pricesinteradays__predictions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pricesinteradays__predictions');
    }
}
